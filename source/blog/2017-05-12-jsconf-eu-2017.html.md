...
Building tools and events for that are accessible to all people is achievable **if you prioritise it**. And you should because it's just the right thing to do, and if you need another reason, you should because it benefits everyone.
